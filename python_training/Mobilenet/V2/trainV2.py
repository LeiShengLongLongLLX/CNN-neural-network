...
from MobileV2 import MobileNetV2  # 导入MobileNetV2模型
...
def main():
    ...
    # 数据预处理，SVHN 图片尺寸是32x32，normalize参数为3通道
    ...
    # 保存模型权重
    torch.save(model.state_dict(), "G:\\Project\\CNN_accerator_basedonRISC-V\\ModelWeigh\\MobileNetV2_svhn.pth")
    print("Model have been saved to MobileNetV2_svhn.pth")
