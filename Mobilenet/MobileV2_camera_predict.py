...
def load_model(model_path):
    ...
    model = MobileNetV2(num_classes=10)        # 数字分类 0~9
...
# 3. 主程序：摄像头实时预测
def main():
    model_path = 'G:\\Project\\CNN_accerator_basedonRISC-V\\ModelWeigh\\mobilenetv2_svhn.pth'
    ...
    while True:
        ...
        cv2.imshow('MobileNetV2 Camera Demo', frame)
